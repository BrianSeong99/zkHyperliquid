  ...
  return (
    <div className="h-full flex flex-col">
      ...
      <div className="flex-1 overflow-auto">
          ...
          {sellOrders.map((order, index) => (
            ...
            >
              ...
              <div className="relative h-full">
                <div
                  className="absolute top-0 right-0 h-full bg-red-900 opacity-20"
        ...
        {/* Spread Indicator */}
        <div className="px-4 py-2 bg-gray-800 border-t border-b border-gray-700 text-xs flex justify-between">
          <span>Spread</span>
          <span>
        ...
        <div>
          {buyOrders.map((order, index) => (
            ...
            >
              ...
              <div className="relative h-full">
                <div
                  className="absolute top-0 right-0 h-full bg-green-900 opacity-20"
                  style={{ width: `${order.depth}%` }}
                ></div>
              </div>
            </div>
